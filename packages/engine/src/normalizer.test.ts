...
test("normalizes a discovery-style collection", () => {
  const raw = [
    {
      title: "Guide to KV caching",
      url: "https://modal.com/blog/kv?utm=1",
    ...
    },
    {
      ...
      url: "https://modal.com/blog/serving",
      date: "2026-06-01",
      content: "other",
    },
  ];
...
test("cleans tracking params from urls and dedupes by id", () => {
  const raw = [
    {
      title: "A",
      url: "https://anyscale.com/blog/a?utm_source=twitter",
      date: "2026-01-01",
      body: "x",
    },
    {
      title: "A",
      url: "https://anyscale.com/blog/a?utm_source=linkedin",
      date: "2026-01-01",
      body: "x",
    },
  ];
...
test("uses fetched time when no date exists", () => {
  const out = normalizeSourceItems(
    "vllm-docs",
    [{ title: "page", url: "https://docs.vllm.ai/x", body: "b" }],
